...
var review_section_para = document.getElementById('review-section-disc');
...
next_review.addEventListener('click', function (e) {
    e.preventDefault();
    if (itemnumber == '3') {
        itemnumber = '0';
    }
...
previous_review.addEventListener('click', function (e) {
    e.preventDefault();
    if (itemnumber == '0') {
        itemnumber = '3';
    }
